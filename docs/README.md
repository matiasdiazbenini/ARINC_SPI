...
Indice rapido para retomar el trabajo y ubicar las fuentes mas importantes.
...
- [plan_mejoras_post_tutor_arinc429.md](plan_mejoras_post_tutor_arinc429.md)
- [Entrega consolidada para el tutor](entrega_tutor/README.md)
...
- [Indice de diagramas](diagramas_bloques/README.md)
