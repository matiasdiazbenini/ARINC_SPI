...
Los resultados obtenidos son positivos. Se valido el funcionamiento del sistema completo, se comprobaron corridas largas de muchas horas sin caidas funcionales, se definio un perfil operativo recomendado y se completo la validacion instrumental mediante osciloscopio. La plataforma quedo cerrada como una recreacion logica y temporal de ARINC 429 sobre niveles GPIO, con evidencia de retorno a cero, palabra de 32 bits, operacion a 100 kbps y 12.5 kbps, captura pasiva y visualizacion web.
...
La validacion con osciloscopio permite demostrar visualmente que la fase \texttt{arinc429\_logic} implementa una recreacion logica/temporal con retorno a cero. En particular, se registraron capturas a 100 kbps y 12.5 kbps para confirmar duracion de bit, longitud de palabra y separacion visible entre palabras.
...
\section{Resultados instrumentales finales}

La medicion final del 2026-06-29 dejo los siguientes valores:

\begin{table}[H]
\centering
\caption{Mediciones temporales finales con osciloscopio}
\begin{tabular}{lll}
\toprule
...
La relacion entre gaps visibles medidos fue:
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{TEK0014_100k_palabra_320us.JPG}
\caption{Medicion a 100 kbps: palabra ARINC logica completa de 32 bits en 320 us.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{TEK0009_12k5_gap_360us.JPG}
\caption{Medicion a 12.5 kbps: gap visible entre palabras de aproximadamente 360 us.}
\end{figure}
...
La arquitectura demostro ser robusta y flexible. El trabajo realizado cumple los objetivos funcionales de esta parte logica: generacion de palabras, transmision bipolar logica con retorno a cero, recepcion, sniffing pasivo, transporte SPI por tramas completas, visualizacion, registro estadistico y validacion instrumental.
...
\begin{itemize}[leftmargin=1.2cm]
    ...
    \item seleccion final de capturas del osciloscopio,
