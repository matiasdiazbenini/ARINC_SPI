...
\section{Gap temporal entre bits}
...
nulo, validado por osciloscopio.
...
La medicion con osciloscopio confirmo el retorno a cero, la duracion de bit y
la forma diferencial logica. El transporte SPI por tramas completas, la linea
DRDY y el supervisor convierten al sistema en una plataforma operable y no solo
en una prueba aislada de firmware.
