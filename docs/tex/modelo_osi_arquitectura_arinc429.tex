...
\midrule
4 & Transporte & Transporte extremo a extremo entre procesos de alto nivel. & TCP sobre puertos \texttt{5000}, \texttt{5100}, \texttt{9090} y \texttt{3000}. \\
\midrule
3 & Red & Direccionamiento IP y alcance entre nodos de la red local. & Raspberry Pi 3B+ en \texttt{192.168.0.200}, loopback \texttt{127.0.0.1} para Prometheus/Grafana locales, acceso HTTP desde la PC a la 3B+. \\
\midrule
...
\midrule
C: Raspberry Pi 3B+ $\leftrightarrow$ PC / navegador / monitoreo & 3 a 7 & Exposicion de estado del sistema a traves de software de aplicacion sobre red IP local. & Bridge en \texttt{:5100}, Flask en \texttt{:5000}, Prometheus en \texttt{:9090}, Grafana en \texttt{:3000}, IP \texttt{192.168.0.200}. \\
\bottomrule
\end{longtable}
...
\begin{tikzpicture}[x=1cm,y=1cm,>=latex]
    ...
    \node[softbox] (bridge) at (5,-6) {Raspberry Pi 3B+\\Bridge HTTP\\\texttt{:5100}};
    ...
    \draw[thick] (bridge) -- node[above left]{HTTP\\\texttt{192.168.0.200:5000}} (flask);
    \draw[thick] (bridge) -- node[right]{\texttt{/metrics}\\\texttt{192.168.0.200:5100}} (prom);
...
\begin{tikzpicture}[x=1cm,y=1cm]
    ...
    \node[layer,fill=cyan!10]   (l3) at (0,2.6) {\textbf{Capa 3 - Red:} IP local, Raspberry Pi 3B+ en 192.168.0.200, loopback 127.0.0.1};
